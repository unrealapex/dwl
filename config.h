...
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xbbbbbbff, 0x0d0d0dff, 0x0d0d0dff },
	[SchemeSel]  = { 0xeeeeeeff, 0xb03060ff, 0xb03060ff },
...
#define MODKEY2 WLR_MODIFIER_ALT
...
static const Key keys[] = {
	...
	{ MODKEY2,                   XKB_KEY_space,      spawn,          {.v = menucmd} },
...
static const Button buttons[] = {
	...
	{ ClkTagBar,   0,      BTN_LEFT,   toggleview,     {0} },
	{ ClkTagBar,   0,      BTN_RIGHT,  view,           {0} },
